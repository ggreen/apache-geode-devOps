...
#export SSH_IDENTITY="-i /Projects/LifeSciences/Humana/dev/aws/vantage-load-test/VANTAGE-POC-KEYPAIR.pem"
export SSH_IDENTITY="-i keys/CHASE-KEYPAIR.pem"

# For use cases that use a cache XML
...
export GEM_TAR_BALL=pivotal-gemfire-9.3.0.tgz
export GEMFIRE_FOLDER_NM=pivotal-gemfire-9.3.0
...
export SSL_ENABLED_COMPONENTS=cluster,gateway,locator,server
...
#Log/Stats
export ENABLE_TIME_STATISTICS=true
...
#Memory
export DATA_NODE_HEAP_SIZE=10g
export LOCATOR_HEAP_SIZE=2g
...
export MAX_CONNECTIONS=80
export PULSE_HTTP_PORT=17070
#export PULSE_HTTP_PORT=80
